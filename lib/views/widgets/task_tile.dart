                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          FormatText().formatDescription(task.name),
                    ...
                    Column(
                      children: [
                        ...
                        CircleAvatar(
                          backgroundColor: getColorByState(task.state),
                          radius: 10,
                        )
                      ],
                    )
  ...
  Color getColorByState(TasksState state) {
    switch (state) {
      case TasksState.TO_DO:
        return ColorController().toDoColor;
      case TasksState.ON_PROGRESS:
        return ColorController().onProgressColor;

      case TasksState.DONE:
        return ColorController().doneColor;
    }
  }
  ...
  Color getColorByPriority(TaskPriority priority) {
    switch (priority) {
      case TaskPriority.HIGH:
        return ColorController().highPriorityColor;
      case TaskPriority.MEDIUM:
        return ColorController().mediumPriorityColor;
      case TaskPriority.LOW:
        return ColorController().lowPriorityColor;
    }
  }
}
